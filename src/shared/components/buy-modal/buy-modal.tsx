...
function BuyModal(props: any, ref: any) {
  ...
  const tokenContract = new web3.eth.Contract(
    tokenAbi,
    "0xcC046a8ba1f82B4FbB186f76e23E3DbEf297dA4c"
  );
      ...
      >
        <div className="action-modal">
          ...
          <div className="contents">
            <h2 className="mb-15">
              Buy #{props.item.tokenId} for{" "}
              {FormattingService.formatBalance(props.item.listPrice)} SHOO
            </h2>
            <p>
        ...
        <span className="estimate">
          Full Price: {props.item.listPrice}{" "}
